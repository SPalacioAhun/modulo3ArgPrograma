...
function Hoy() {
  ...
  useEffect(() => {
    const apiUrl = 'https://api.open-meteo.com/v1/forecast?latitude=-37.3217&longitude=-59.1332&current=temperature_2m,weathercode&hourly=temperature_2m,visibility,uv_index&daily=temperature_2m_max,temperature_2m_min,sunrise,sunset&timezone=America%2FSao_Paulo';
      ...
      <div>
        ...
        <div className="description">
          ...
          {climaCode !== null && (
            <div>
              <img
                src={codigoClima[climaCode].icons}
                alt="Ícono de Clima"
              />
