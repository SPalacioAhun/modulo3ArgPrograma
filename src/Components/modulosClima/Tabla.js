...
function Tabla() {
  ...
  useEffect(() => {
    const apiUrl = 'https://api.open-meteo.com/v1/forecast?latitude=-37.3217&longitude=-59.1332&hourly=temperature_2m&timezone=America%2FSao_Paulo&forecast_days=1';
